...
namespace KthulhuWantsMe.Source.Gameplay.TentacleIK
{
    ...
    public class TentacleController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _tentacleFsm.AddState(TentacleState.Idle.ToString(), new TentacleIdleState(_tentacleAnimator, _playerMovementController));
            _tentacleFsm.AddState(TentacleState.GrabPlayer.ToString(), new TentacleGrabPlayerState(_tentacleAnimator, _playerMovementController, _playerFollowTarget));
            _tentacleFsm.AddState(TentacleState.Stunned.ToString(), new TentacleStunnedState(this, _tentacleAnimator, _playerMovementController));
