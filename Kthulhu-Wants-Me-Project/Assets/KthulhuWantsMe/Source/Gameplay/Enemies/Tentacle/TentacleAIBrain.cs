...
namespace KthulhuWantsMe.Source.Gameplay.Enemies.Tentacle
{
    public class TentacleAIBrain : MonoBehaviour
    {
        ...
        private bool CanDoBasicAttack() =>
            _tentacleAttack.CanAttack() 
            && _tentacleAggro.HasAggro 
            && _tentacleAggro.IsPlayerInFront 
            && _tentacleAggro.DistanceToPlayer() < _tentacleConfiguration.AttackActivationDistance;
