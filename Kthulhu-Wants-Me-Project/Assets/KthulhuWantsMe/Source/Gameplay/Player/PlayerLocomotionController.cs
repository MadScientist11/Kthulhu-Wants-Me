...
{
    public class PlayerLocomotionController : ICharacterController
    {
        ...
        public PlayerLocomotionController(IGameFactory gameFactory, KinematicCharacterMotor motor,
        ...
        public void UpdateState()
        {
            ...
            {
                ToggleMotor(false);
                _gameFactory.Player.transform.SetPositionAndRotation(_followTarget.position, _followTarget.rotation);
            }
        }
